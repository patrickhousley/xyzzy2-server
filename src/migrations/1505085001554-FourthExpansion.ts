...
export class FourthExpansion1505085001554 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.insert('black_card', {
      text: `You've seen the bearded lady!<br/>You've seen the ring of fire!<br/>Now, ladies and gentlemen, feast your eyes upon ____!`,
      draw: 0,
      pick: 1,
      watermark: `X4`,
      cardSetId: insertResult.result![0].id
    ...
    await queryRunner.insert('black_card', {
      text: `She's up all night for good fun.<br/>I'm up all night for ____.`,
      draw: 0,
      pick: 1,
      watermark: `X4`,
      cardSetId: insertResult.result![0].id
    ...
    await queryRunner.insert('black_card', {
      text: `Dear Leader Kim Jong-un,<br/>our village praises your infinite wisdom with a humble offering of ____.`,
      draw: 0,
      pick: 1,
      watermark: `X4`,
      cardSetId: insertResult.result![0].id
    ...
    await queryRunner.insert('black_card', {
      text: `Alright, bros. Our frat house is condemned, and all the hot slampieces are over at Gamma Phi. The time has come to commence Operation ____.`,
      draw: 0,
      pick: 1,
      watermark: `X4`,
      cardSetId: insertResult.result![0].id
    ...
    await queryRunner.insert('black_card', {
      text: `Every step towards ____ gets me a little closer to ____.`,
      draw: 0,
      pick: 2,
      watermark: `X4`,
      cardSetId: insertResult.result![0].id
    ...
    await queryRunner.insert('black_card', {
      text: `In the beginning, there was ____.<br/>And the Lord said, "Let there be ____."`,
      draw: 0,
      pick: 2,
      watermark: `X4`,
      cardSetId: insertResult.result![0].id
    ...
    await queryRunner.insert('black_card', {
      text: `Adventure.<br/>Romance.<br/>____.<br/><br/>From Paramount Pictures, "____."`,
      draw: 0,
      pick: 2,
      watermark: `X4`,
      cardSetId: insertResult.result![0].id
